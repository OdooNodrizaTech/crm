...
class ResPartner(models.Model):
    ...
    @api.multi    
    def cron_odoo_res_partner_fields_generate(self, cr=None, uid=False, context=None):
    ...
    @api.multi    
    def cron_odoo_res_partner_fields_generate_days(self, cr=None, uid=False, context=None):
